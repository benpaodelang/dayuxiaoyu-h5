...
mejs.Utility = {
    ...
    getScriptPath: function(a) {
        ...
        c, d = "",
        e = "",
        g, f = document.getElementsByTagName("script"), j = f.length, h = a.length; b < j; b++) {
            g = f[b].src;
            for (c = 0; c < h; c++) {
                e = a[c];
                if (g.indexOf(e) > -1) {
...
mejs.YouTubeApi = {
    ...
    createFlash: function(a) {
        ...
        var b, c = "" + a.pluginId + "&amp;version=3&amp;autoplay=0&amp;controls=0&amp;modestbranding=1&loop=0";
        if (mejs.MediaFeatures.isIE) {
...
if (typeof jQuery != "undefined") mejs.$ = jQuery;
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        showControls: function(a) {
            ...
            if (!c.controlsAreVisible) {
                if (a) {
                    c.controls.css("visibility", "visible").stop(true, true).fadeIn(100,
                    function() {
                        c.controlsAreVisible = true
                    });
                    c.container.find(".mejs-control").css("visibility", "visible").stop(true, true).fadeIn(100,
                    function() {
                        c.controlsAreVisible = true
                    })
                } else {
        ...
        hideControls: function(a) {
            ...
            if (c.controlsAreVisible) if (a) {
                c.controls.stop(true, true).fadeOut(100,
                function() {
                    f(this).css("visibility", "hidden").css("display", "block");
                    c.controlsAreVisible = false
                });
                c.container.find(".mejs-control").stop(true, true).fadeOut(100,
                function() {
                    f(this).css("visibility", "hidden").css("display", "block")
                })
            } else {
        ...
        meReady: function(a, c) {
            ...
            if (!b.created) {
                ...
                if (! (d.isAndroid && b.options.AndroidUseNativeControls) && !(d.isiPad && b.options.iPadUseNativeControls) && !(d.isiPhone && b.options.iPhoneUseNativeControls)) {
                    ...
                    b.setControlsSize();
                    if (b.isVideo) {
                        if (mejs.MediaFeatures.hasTouch) b.$media.bind("touchstart",
                        function() {
                            if (b.controlsAreVisible) b.hideControls(false);
                            else b.controlsEnabled && b.showControls(false)
                        });
                        else { (b.media.pluginType == "native" ? b.$media: f(b.media.pluginElement)).click(function() {
                        ...
                        b.options.enableAutosize && b.media.addEventListener("loadedmetadata",
                        function(h) {
        ...
        buildkeyboard: function(a, c, b, d) {
            f(document).keydown(function(e) {
                ...
                k = a.options.keyActions.length; g < k; g++) for (var h = a.options.keyActions[g], o = 0, n = h.keys.length; o < n; o++) if (e.keyCode == h.keys[o]) {
                    e.preventDefault();
                    h.action(a, d);
                    return false
                }
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        updateCurrent: function() {
            if (this.currenttime) this.currenttime.html(mejs.Utility.secondsToTimeCode(this.media.currentTime, this.options.alwaysShowHours || this.media.duration > 600, this.options.showTimecodeFrameCount, this.options.framesPerSecond || 25))
        },
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        buildfullscreen: function(a, c, b, d) {
            if (a.isVideo) {
                ...
                mejs.MediaFeatures.hasTrueNativeFullScreen && a.container.bind(mejs.MediaFeatures.fullScreenEventName,
                function() {
    ...
    f.extend(MediaElementPlayer.prototype, {
            ...
            if (a.isVideo) if (a.tracks.length != 0) {
                ...
                a.container.hover(function() {
                    if (a.hasChapters) {
                        ...
                        a.chapters.fadeIn(100)
                    }
                },
                function() {
                    a.hasChapters && !d.paused && a.chapters.fadeOut(100,
                    function() {
        ...
        loadTrack: function(a) {
            ...
            b.isTranslation ? mejs.TrackFormatParser.translateTrackText(c.tracks[0].entries, c.tracks[0].srclang, b.srclang, c.options.googleApiKey,
            function(e) {
                b.entries = e;
                d()
            }) : f.ajax({
    ...
    mejs.TrackFormatParser = {
        ...
        parse: function(a) {
            ...
            d, e; c < a.length; c++) if (this.pattern_identifier.exec(a[c])) {
                c++;
    ...
    if ("x\n\ny".split(/\n/gi).length != 3) mejs.TrackFormatParser.split2 = function(a, c) {
        var b = [],
        d = "",
        e;
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function(a, c) {
            for (var b = this,
            d = "",
            e = b.options.contextMenuItems,
            g = 0,
            k = e.length; g < k; g++) if (e[g].isSeparator) d += '<div class="mejs-contextmenu-separator"></div>';
            else {
                var h = e[g].render(b);
